              ...
              <tbody>
                  ...
                  @foreach ($marcas as $marca)
                      <tr>
                          <td>{{ $marca->id }}</td>
                          <td>{{ $marca->name }}</td>
                          <td><img width="100px" src="{{ Storage::disk("s3")->url($marca->imagen) }}"></td>

                          <td>
                            @if ($marca->state == 1)
                                <div class='btn btn-success btn-xs ' > Activo</div>
                            @else
                                <button class='btn btn-danger btn-xs ' > desactivo</button>
                            @endif
