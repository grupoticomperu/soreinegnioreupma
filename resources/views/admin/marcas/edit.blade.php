                ...
                <div class="card-body">
                  ...
                  <div class="col-md-6">
                    <div class="image-wrapper">
                        @isset($marca->imagen)
                            <img width="400px" id="image" src="{{Storage::disk("s3")->url($marca->imagen)}}" alt="">
                        @else
                            <p>No hay imagen</p>
                        @endif
                  ...
                  <div class="form-group ">
                    ...
                    <input name="order" type="number" class="form-control" id="order" placeholder="Ingrese orden" value="{{old('order', $marca->order)}}">
