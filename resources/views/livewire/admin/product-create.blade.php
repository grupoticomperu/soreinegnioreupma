            ...
            <div class="col-md-4">
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body col-md-12">
                        ...
                        <div class="form-group {{ $errors->has('typeproduct_id') ? 'text-danger' : ''}}">
                            <label>Tipo Producto</label>
                            <select wire:model="typeproduct_id" class="form-control">
            ...
            <div class="col-md-2">
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body col-md-12">
                        ...
                        <div class="form-group {{ $errors->has('currency_id') ? 'text-danger' : ''}}">
                            <label>Moneda</label>
                            <select wire:model="currency_id" class="form-control">
                                <option value="">Escoger</option>
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body col-md-12">
                        ...
                        <div class="form-group {{ $errors->has('description') ? 'text-danger' : '' }}">
                            <div wire:ignore>
                                <label class="text-danger">descripción del producto </label>
                                <textarea id="editor" wire:model.defer="description" value="{{ old('description') }}" rows="10" class="form-control"
                                    placeholder="Ingrese decripción del producto">{{ old('description') }}</textarea>
                            </div>
                        ...
                        <div class="form-group {{ $errors->has('video') ? 'text-danger' : '' }}">
                            ...
                            <textarea wire:model="video" rows="2" value="{{ old('video') }}" class="form-control"
                        ...
                        <div class="form-group {{ $errors->has('brochure') ? 'text-danger' : '' }}">
                            ...
                            <input type="file" wire:model="brochure" value="{{ old('brochure') }}" >

                            {!! $errors->first('brochure', '<span class="help-block">:message</span>') !!}
                        </div>

                        <div class="mb-2 mr-4 flex">
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body col-md-12">
                        <div class="form-group {{ $errors->has('titlegoogle') ? 'text-danger' : '' }}">
                            ...
                            <input wire:model="titlegoogle"  value="{{ old('titlegoogle') }}" type="text"
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body col-md-12">
                        <div class="form-group {{ $errors->has('descriptiongoogle') ? 'text-danger' : '' }}">
                            ...
                            <textarea rows="3" wire:model="descriptiongoogle" value="{{ old('descriptiongoogle') }}" class="form-control"
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body col-md-12">
                        ...
                        <div class="form-group {{ $errors->has('keywordsgoogle') ? 'text-danger' : '' }}">
                            ...
                            <input wire:model="keywordsgoogle" value="{{ old('keywordsgoogle') }}" type="text"
                                class="form-control" placeholder="ingrese aquí el título del producto">
                            <!-- el segundo parametro del old sirve para pintar en caso este vacio -->
                            <!-- <div class="poner la clase para sombrear solo el mensaje">-->
