                        ...
                        @foreach ($products as $product )
                            <div class="col-6 col-md-4">
                                <article class="product">
                                    <div class="product-figure"><img class="lazy-img product-image" src="data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs%3D" data-src="{{ Storage::disk("s3")->url($product->image1 ) }}" alt="{{ $product->name }}" width="290" height="372">
